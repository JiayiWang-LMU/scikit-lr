...
class BaseForest(BaseEnsemble, ABC):
    ...
    def fit(self, X, Y, sample_weight=None):
        """Build a forest_models of trees from the training set (X, Y).
        ...
        # Return the built forest_models ensemble
        return self
...
class ForestLabelRanker(LabelRankerMixin, BaseForest, ABC):
    """Base class for forest_models of trees-based Label Rankers.
...
class ForestPartialLabelRanker(PartialLabelRankerMixin, BaseForest, ABC):
    """Base class for forest_models of trees-based Partial Label Rankers.
...
class RandomForestLabelRanker(ForestLabelRanker):
    """A random forest_models Label Ranker.
...
class RandomForestPartialLabelRanker(ForestPartialLabelRanker):
    """A random forest_models Partial Label Ranker.
